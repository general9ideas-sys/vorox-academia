...
const outDir = join(__dirname, '..', 'plataforma');
...
const pages = [
  {
    ...
    blocks: [
      { h: 'Cómo funciona', items: [
        ...
        'Las charlas complementarias también se dictan por Meet.',
        'Grabaciones disponibles para quienes no puedan asistir en directo.',
      ]},
      { h: 'Para el estudiante', items: [
        'Accedés al link de Meet desde tu aula virtual.',
        'Participás en dinámicas prácticas y trabajo en grupo.',
        'Recibís recordatorios antes de cada sesión.',
      ]},
    ],
  },
  {
    ...
    blocks: [
      { h: 'Qué incluye', items: [
        'Fundamentos según la carrera: lógica, matemática, herramientas o inglés técnico.',
        'Material en aula virtual con videos, lecturas y ejercicios.',
        'Sin costo extra en tu proceso de admisión a VOROX.',
        'Certificado de nivelación al completar módulos obligatorios.',
      ]},
  ...
  },
  {
    ...
    blocks: [
      { h: 'Tu campus digital', items: [
        ...
        'Materiales, slides y enlaces a Meet por cada clase.',
        'Entrega de tareas, quizzes y proyectos desde la misma plataforma.',
        'Historial de avance y comunicación con profesores.',
      ]},
      { h: 'Coordinación con el profesor', items: [
        'Syllabus, objetivos y criterios de evaluación por módulo.',
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: 'Cómo se alimenta', items: [
        ...
        'Complementa la mentoría humana de VOROX.',
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      { h: 'Estructura del servidor', items: [
        ...
        'Anuncios, recursos y eventos de la comunidad.',
      ]},
      { h: 'Beneficios', items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: 'En la práctica', items: [
        'Resolvés ejercicios sin instalar entorno local.',
        'Proyectos evaluados con mismos tests que usa el profesor.',
        'Ideal para pair programming en Meet o Discord.',
      ]},
    ],
  },
  {
    ...
    blocks: [
      ...
      { h: 'Tu portfolio', items: [
        'Publicás proyectos aprobados desde el aula.',
        'Feedback de mentores antes de exhibir.',
  ...
  },
  {
    ...
    blocks: [
      { h: 'Tipos de evaluación', items: [
        ...
        'Nota mínima para avanzar al siguiente módulo.',
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: 'Acompañamiento', items: [
        ...
        'Conexión con empresas del carrusel de egresados.',
      ]},
    ],
  },
  {
    ...
    lead: 'Al completar tu carrera recibís certificado oficial VOROX con dos copias: digital y física para empleadores.',
    blocks: [
      { h: 'Entrega', items: [
        ...
        'Válido para presentar ante empresas.',
      ]},
      { h: 'Requisitos', items: [
        'Aprobar evaluaciones y proyecto final.',
        'Asistencia mínima a clases en vivo.',
  ...
  },
  {
    ...
    blocks: [
      { h: 'Qué podés comprar', items: [
        ...
        'Addons: mentorías extra y certificaciones adicionales.',
      ]},
      { h: 'Experiencia', items: [
    ...
    <section class="feature-hero">
      <div class="container">
        ...
        <div class="feature-hero__actions">
          ...
          <a href="../index.html#plataforma" class="btn btn--outline-nav btn--lg">Ver ecosistema</a>
        </div>
      </div>
    </section>
